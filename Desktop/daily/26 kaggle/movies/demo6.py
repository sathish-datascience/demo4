...
sns.lineplot(x = df['year'].value_counts().index,y = df['year'].value_counts().values,marker="*",color="red")
...
sns.barplot(y = top_rated['title'],
		x = top_rated['vote_average'],palette="viridis")

plt.title("count wise movies")
plt.show()
